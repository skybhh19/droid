...
from dm_robotics.moma.effectors import arm_effector, cartesian_6d_velocity_effector, cartesian_4d_velocity_effector
...
class RobotIKSolver:
    def __init__(self):
        ...
        self._cart_effector_4d = cartesian_4d_velocity_effector.Cartesian4dVelocityEffector(
            effector_6d=self._cart_effector_6d, element=self._arm.wrist_site, effector_prefix=f'{self._arm.name}_cart_4d_vel'
        )
        self._cart_effector_4d.after_compile(self._arm.mjcf_model, self._physics)
    ...
    def cartesian_velocity_to_joint_velocity(self, cartesian_velocity, robot_state):
        ...
        self._cart_effector_4d.set_control(self._physics, cartesian_delta)
    ...
    def cartesian_velocity_to_delta(self, cartesian_velocity):
        ...
        lin_vel, rot_vel = cartesian_velocity[:3], np.array(cartesian_velocity[3:4])
        ...
        return np.concatenate([lin_delta, rot_delta[0:1]])
    ...
    def cartesian_delta_to_velocity(self, cartesian_delta):
        ...
        cartesian_velocity[3:6] = cartesian_delta[3:4] / self.max_rot_delta
