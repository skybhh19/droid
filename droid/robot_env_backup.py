...
class RobotEnv(gym.Env):
    def __init__(self, action_space_type="cartesian_velocity", gripper_action_space_type=None, camera_kwargs={}, do_reset=True):
        # Initialize Gym Environment
        super().__init__()

        # Define Action Space #
        assert action_space_typein ["cartesian_position", "joint_position", "cartesian_velocity", "joint_velocity"]
        self.action_space_type= action_space
        self.gripper_action_space_type= gripper_action_space
