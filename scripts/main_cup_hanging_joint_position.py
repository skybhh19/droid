...
TASK_PROMPT = "Hang the cup on the hook"
...
class Args:
    # Hardware parameters
    external_camera_id: str = "31078156"  # Cup-hanging exterior camera (left stereo image).
...
def main(args: Args):
    ...
    while True:
        ...
        save_filename = "cup_hanging_joint_position_video_" + timestamp
        video_path = ""
    ...
    csv_filename = os.path.join("results", f"eval_cup_hanging_joint_position_{timestamp}.csv")
