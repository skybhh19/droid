...
class Args:
    # Hardware parameters
    external_camera_id: str = "31078156"  # e.g., "24259877"
...
def main(args: Args):
    ...
    instruction = "Hang the cup on the hook"
    while True:
        ...
        save_filename = "cup_hanging_joint_velocity_video_" + timestamp
        video_path = ""
    ...
    csv_filename = os.path.join("results", f"eval_cup_hanging_joint_velocity_{timestamp}.csv")
