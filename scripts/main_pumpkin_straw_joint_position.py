...
TASK_PROMPT = "Insert the straw into the pumpkin cup"
...
class Args:
    # Hardware parameters
    external_camera_id: str = "31078156"  # Pumpkin-straw exterior camera (left stereo image).
    wrist_camera_id: str = "17471093"  # Wrist camera (left stereo image).
    ...
    remote_port: int = 8123  # policy server port; match your serving command
...
def main(args: Args):
    ...
    while True:
        ...
        save_filename = "pumpkin_straw_joint_position_video_" + timestamp
        video_path = ""
    ...
    csv_filename = os.path.join("results", f"eval_pumpkin_straw_joint_position_{timestamp}.csv")
