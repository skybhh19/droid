...
TASK_PROMPT = "Hang the spatula on the hook"
...
class Args:
    ...
    remote_port: int = 8123  # default spatula-on-hook policy server port
...
def main(args: Args):
    ...
    while True:
        ...
        save_filename = "spatula_on_hook_joint_position_video_" + timestamp
        video_path = ""
    ...
    csv_filename = os.path.join("results", f"eval_spatula_on_hook_joint_position_{timestamp}.csv")
